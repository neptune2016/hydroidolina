...
usage = """
Converts an alignment from nexus format to phylip format

usage:

python nexus2phylip in.nex > out.phy
...
def nexus2phylip( in_name ):
	...
	alignment = AlignIO.read( in_name , "nexus" )
